...
def swap_placement(
    ...
    return not has_baseline(data, plant_id, new_placement)
...
def clear_all_plants(data: dict[str, Any]) -> None:
    """Wipe all learned baselines/calibration/dormancy (database reset)."""
    data["plants"] = {}
