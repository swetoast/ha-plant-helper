...
async def async_setup_entry(
    ...
    # Hub-level source/API diagnostics.
    entities.append(RadiationSourceIssueBinary(coordinator, entry))
...
class PlantSensorFaultBinary(_PlantBinaryBase):
    ...
    def extra_state_attributes(self) -> dict:
        ...
        return {
            ...
            "linked_sources": self.coordinator.linked_sources(self._plant_id),
        }
...
class RadiationSourceIssueBinary(CoordinatorEntity, BinarySensorEntity):
    """Diagnostic problem indicator for the active radiation source."""

    _attr_has_entity_name = True
    _attr_name = "Radiation source issue"
    _attr_entity_category = EntityCategory.DIAGNOSTIC
    _attr_device_class = BinarySensorDeviceClass.PROBLEM
    ...
    def __init__(self, coordinator, entry: ConfigEntry) -> None:
        ...
        self._entry = entry
        self._attr_unique_id = f"{entry.entry_id}_radiation_source_issue"
    ...
    @property
    def is_on(self) -> bool:
        status = getattr(self.coordinator, "radiation_status", {}) or {}
        return not status.get("available", True) or bool(status.get("last_error"))

    @property
    def extra_state_attributes(self):
        return getattr(self.coordinator, "radiation_status", {}) or {}
...
class ApiHealthBinary(CoordinatorEntity, BinarySensorEntity):
    ...
    def extra_state_attributes(self) -> dict:
        ...
        return {
            ...
            "partial_result": health.get("partial_result"),
