...
MODULE_OWNERS = {
    ...
    "config_flow.py": "configuration and options behavior",
...
PUBLIC_SYMBOLS = {
    ...
    "config_flow.py": {"PlantHelperConfigFlow", "PlantHelperOptionsFlow"},
    ...
    "plant_config.py": {"slug", "unique_plant_id", "validate_plant", "split_record"},
