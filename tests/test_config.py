...
@pytest.mark.parametrize("raw,key", [({"latitude":float("nan")},"latitude"),({"longitude":181},"longitude"),({"update_interval":True},"update_interval"),({"perenual_access_level":"x"},"perenual_access_level"),({"ozone_entity":"binary_sensor.x"},"ozone_entity")])
