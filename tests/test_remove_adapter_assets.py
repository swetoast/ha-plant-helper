...
def test_remove_flow_and_registry_hooks():
 ...
 assert 'await async_remove_plant(' in src and 'phase_11_not_implemented' not in src
 assert 'await entity.async_remove()' in src and 'step_id="confirm_remove"' in src
